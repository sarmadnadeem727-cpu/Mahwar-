...
import { 
  ArrowRight, Sparkles, Cpu, Play, BarChart3, Layers, 
  FileSpreadsheet, ShieldCheck, Activity, Terminal, CheckCircle2, TrendingUp
} from "lucide-react";
import { useTerminalStore } from "@/store/useTerminalStore";
import { t } from "@/lib/i18n";
import { fadeInUp, staggerContainer, staggerItem, interactiveHover } from "@/lib/motion";
...
export default function HeroSection() {
  ...
  const typewriterPhrases = isAr ? [
    ...
    "أبحاث الأسهم المدعومة بـ Gemini 2.5 Flash والبيانات الحية",
  ] : [
    ...
    "Gemini 2.5 Flash-Powered Equity Research Memos",
  ];
  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col justify-center bg-[#FFFFFF] text-[#171717] pt-28 pb-16 overflow-hidden border-b border-terminal-border select-none">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col items-center">
        ...
        <motion.div
          ...
          className="w-full max-w-5xl bg-white rounded-xl border border-terminal-border-strong shadow-terminal-card overflow-hidden text-left rtl:text-right"
          dir={isAr ? "rtl" : "ltr"}
        >
          {/* MOCKUP HEADER BAR */}
