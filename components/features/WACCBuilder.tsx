      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="panel-input p-5 space-y-4">
            ...
            <div className="mt-4 p-3 bg-ink-3 border border-line rounded flex justify-between items-center">
              <span className="font-bold text-xs text-fg-2 font-mono">{isAr ? "تكلفة الملكية المحسوبة" : "Implied Ke"}</span>
          ...
          <div className="space-y-6">
            <div className="panel-input p-5 space-y-4">
              ...
              <div className="mt-4 p-3 bg-ink-3 border border-line rounded flex justify-between items-center">
                <span className="font-bold text-xs text-fg-2 font-mono">{isAr ? "تكلفة الدين (بعد الضريبة)" : "Implied Kd (After-tax)"}</span>
                <span className="font-bold text-fg-2 font-mono">{results.kdAfterTax.toFixed(2)}%</span>
              </div>
            </div>
            ...
            <div className="panel-input p-5 space-y-4">
              ...
              <div className="flex justify-between items-center bg-ink-3 p-2.5 rounded border border-line">
                <span className="text-fg-2 font-bold text-xs font-sans">{isAr ? "وزن الملكية" : "Equity Weight (We)"}</span>
                <span className="font-bold text-xs font-mono text-fg">{equityWeight}%</span>
              </div>
            </div>
          </div>
        </div>
