...
import { cascadeGroup, inViewOnce, useMotionOff } from "../../lib/mw-motion";
        ...
        <Container>
          ...
          >
            ...
            <div className="hidden flex-col justify-end bg-surface-1 p-5 font-mono text-mono-xs text-ink-500 sm:flex">
              ...
              <Link href="/dashboard?panel=ddm" className="mt-1 text-ink-700 hover:text-accent-700 hover:underline">
                Dividend Discount Model
              </Link>
              <Link href="/dashboard?panel=npv_irr" className="text-ink-700 hover:text-accent-700 hover:underline">
                NPV &amp; IRR Calculator
              </Link>
              <Link href="/dashboard?panel=merger_analysis" className="text-ink-700 hover:text-accent-700 hover:underline">
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-12">
            ...
            >
              ...
              <div className="hidden flex-col justify-end bg-surface-1 p-5 sm:flex">
                ...
                <Button href="/dashboard?panel=operations_hub" variant="tertiary" className="mt-2">
