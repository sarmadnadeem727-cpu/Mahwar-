...
export const footerNav: readonly NavGroup[] = [
  {
    heading: "Platform",
    links: [
      { label: "Intelligence Hub", href: "/dashboard?panel=hub" },
      { label: "GCC Wire", href: "/dashboard?panel=news" },
      { label: "BI Report Engine", href: "/dashboard?panel=bi_report" },
      { label: "Operations Suite", href: "/dashboard?panel=operations_hub" },
    ],
  },
  {
    heading: "Models",
    links: [
      { label: "DCF Valuation Engine", href: "/dashboard?panel=DCF" },
      { label: "LBO Deal Builder", href: "/dashboard?panel=LBO" },
      { label: "3-Statement Model", href: "/dashboard?panel=FS" },
      { label: "Custom Model Builder", href: "/dashboard?panel=custom_model" },
    ],
  },
  {
    heading: "Research & Analytics",
    links: [
      { label: "Shariah Screening (AAOIFI)", href: "/dashboard?panel=shariah" },
      { label: "Monte Carlo Simulation", href: "/dashboard?panel=monte_carlo" },
